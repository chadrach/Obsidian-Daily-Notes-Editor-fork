...
function genId(size2) {
  const chars = [];
  for (let n = 0; n < size2; n++) chars.push((16 * Math.random() | 0).toString(16));
  return chars.join("");
}
...
const spawnLeafView = (plugin, initiatingEl, leaf, onShowCallback) => {
  ...
  if (!initiatingEl) initiatingEl = parent == null ? void 0 : parent.containerEl;
...
class DailyNoteEditor extends nosuper(require$$0.HoverPopover) {
  ...
  nativeHide() {
    ...
    if (targetEl) {
      ...
      if (parent) (_a = popovers.get(parent)) == null ? void 0 : _a.transition();
    }
    this.onHide();
    this.unload();
  }
  ...
  async openLink(linkText, sourcePath, eState, createInLeaf) {
    ...
    if (((_c = state2.state) == null ? void 0 : _c.mode) === "source") {
      this.whenShown(() => {
        var _a2, _b2, _c2, _d;
        if (require$$0.requireApiVersion("1.0")) (_c2 = (_b2 = (_a2 = leaf == null ? void 0 : leaf.view) == null ? void 0 : _a2.editMode) == null ? void 0 : _b2.reinit) == null ? void 0 : _c2.call(_b2);
...
class DailyNoteSettingTab extends require$$0.PluginSettingTab {
  ...
  async display() {
    ...
    new require$$0.Setting(containerEl).setName("Create daily note when opening editor").setDesc(
      ...
      (toggle) => toggle.setValue(settings.createOnOpen).onChange(async (value) => {
    ...
    new require$$0.Setting(containerEl).setName("Hide future dates").setDesc("Hide the diary entries for dates that have not yet arrived.").addToggle((toggle) => toggle.setValue(settings.hideUnreachedDates).onChange(async (value) => {
      this.plugin.settings.hideUnreachedDates = value;
      await this.plugin.saveSettings();
    }));
    new require$$0.Setting(containerEl).setName("Auto focus today's note").setDesc(
      "Automatically focus today's note and move the cursor to the end of the document"
    ).addToggle(
      (toggle) => toggle.setValue(settings.autoFocus).onChange(async (value) => {
        this.plugin.settings.autoFocus = value;
        this.applySettingsUpdate();
      })
    );
    new require$$0.Setting(containerEl).setName("Switch to existing editor").setDesc(
      "If an daily notes editor is already open, switch to it rather than open it on a new tab"
    ).addToggle(
      (toggle) => toggle.setValue(settings.switchToExisting).onChange(async (value) => {
...
function getEditor(leaf) {
  ...
  if (!(view2 instanceof require$$0.MarkdownView)) return null;
  return view2.editor;
}
...
function create_if_block_2$1(ctx) {
  ...
  return {
    c() {
      ...
      attr(span0, "class", "collapse-button svelte-1cwbjlj");
      attr(span0, "title", span0_title_value = /*isCollapsed*/
      ctx[7] ? "Expand" : "Collapse");
      attr(span1, "role", "link");
      attr(span1, "class", "clickable-link svelte-1cwbjlj");
      attr(
        span1,
        "data-title",
        /*title*/
      ...
      attr(div, "class", "daily-note-title inline-title svelte-1cwbjlj");
    },
    m(target, anchor) {
...
function create_if_block_1$1(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "editor-placeholder svelte-1cwbjlj");
    },
    m(target, anchor) {
      insert(target, div, anchor);
    },
...
function create_fragment$1(ctx) {
  ...
  return {
    c() {
      ...
      attr(div0, "class", "daily-note-editor svelte-1cwbjlj");
      attr(
        div0,
        "data-collapsed",
        /*isCollapsed*/
      ...
      attr(div1, "class", "daily-note svelte-1cwbjlj");
...
function fileHasBacklinks(app2, file) {
  const resolvedLinks = app2.metadataCache.resolvedLinks;
...
function instance$1($$self, $$props, $$invalidate) {
  ...
  onMount(() => {
    if (file instanceof require$$0.TFile) {
      ...
      $$invalidate(6, rawTitle = basename2);
      const dateFormat = getDailyNoteSettings_1().format || DEFAULT_DAILY_NOTE_FORMAT_1;
      const parsed = require$$0.moment(basename2, dateFormat, true);
      $$invalidate(5, title = parsed.isValid() ? parsed.format("dddd, MMMM Do YYYY") : basename2);
    }
  });
  onDestroy(() => {
    isDestroying = true;
  ...
  function showEditor() {
    ...
    try {
      ...
      if (autoFocus) {
        window.setTimeout(
          () => {
            if ((createdLeaf === null || createdLeaf === void 0 ? void 0 : createdLeaf.view) instanceof require$$0.MarkdownView) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("leaf" in $$props2) $$invalidate(12, leaf = $$props2.leaf);
    if ("shouldRender" in $$props2) $$invalidate(1, shouldRender = $$props2.shouldRender);
...
class FileManager {
  ...
  fetchDailyNotes() {
    ...
    if (baseTimeField === "name") {
      ...
      const today = require$$0.moment().startOf("day");
      const dateKeys = Object.keys(this.cacheDailyNotes).sort().reverse();
      const filteredKeys = this.options.hideUnreachedDates ? dateKeys.filter((date) => require$$0.moment(date, "YYYY-MM-DD").isSameOrBefore(today)) : dateKeys;
      for (const dateStr of filteredKeys) {
        this.allFiles.push(this.cacheDailyNotes[dateStr]);
      }
  ...
  handleDailyNoteCreate(file) {
    ...
    if (fileDate.isSame(require$$0.moment(), "day")) this.hasCurrentDay = true;
  }
...
function create_if_block_2(ctx) {
  ...
  return {
    c() {
      div1 = element("div");
      div1.innerHTML = `<div class="dn-stock-text svelte-1crs25f">No files found</div>`;
      attr(div1, "class", "dn-stock svelte-1crs25f");
    },
    m(target, anchor) {
...
function create_if_block_1(ctx) {
  ...
  return {
    c() {
      div1 = element("div");
      div1.innerHTML = `<div class="dn-blank-day-text svelte-1crs25f">Create a daily note for today ✍</div>`;
      attr(div1, "class", "dn-blank-day svelte-1crs25f");
...
function create_each_block(key_1, ctx) {
  ...
  return {
    ...
    c() {
      ...
      attr(div, "class", "daily-note-wrapper svelte-1crs25f");
      this.first = div;
    },
    m(target, anchor) {
      insert(target, div, anchor);
    ...
    p(new_ctx, dirty) {
      ...
      2) inview_action.update.call(null, {
        rootMargin: "80%",
        unobserveOnEnter: false,
        root: (
          /*leaf*/
...
function create_if_block(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "no-more-text svelte-1crs25f");
    },
    m(target, anchor) {
      insert(target, div, anchor);
    },
...
function create_fragment(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      ...
      if (inview_action && is_function(inview_action.update) && dirty[0] & /*leaf*/
      2) inview_action.update.call(null, { root: (
        /*leaf*/
...
function instance($$self, $$props, $$invalidate) {
  ...
  function focusFileEditor(file, attempts = 0) {
    window.setTimeout(
      () => {
        var _a, _b;
        let targetLeaf = null;
        ...
        if (targetLeaf && targetLeaf.view instanceof require$$0.MarkdownView) {
          ...
          editor.focus();
          editor.setCursor(editor.lineCount(), 0);
          (_b = (_a = targetLeaf.view.containerEl).scrollIntoView) === null || _b === void 0 ? void 0 : _b.call(_a, { block: "center" });
        } else if (attempts < 10) {
  ...
  function isToday(file) {
    ...
    const fileDate = getDateFromFile_1(file, "day");
    return (_a = fileDate === null || fileDate === void 0 ? void 0 : fileDate.isSame(require$$0.moment(), "day")) !== null && _a !== void 0 ? _a : false;
  }
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("leaf" in $$props2) $$invalidate(1, leaf = $$props2.leaf);
    if ("selectedRange" in $$props2) $$invalidate(2, selectedRange = $$props2.selectedRange);
    if ("customRange" in $$props2) $$invalidate(15, customRange = $$props2.customRange);
    if ("selectionMode" in $$props2) $$invalidate(3, selectionMode = $$props2.selectionMode);
    if ("target" in $$props2) $$invalidate(16, target = $$props2.target);
    if ("timeField" in $$props2) $$invalidate(17, timeField = $$props2.timeField);
  };
  $$self.$$.update = () => {
    ...
    229389) {
      fileManagerOptions = {
        ...
        app: plugin.app,
        timeField,
        hideUnreachedDates: plugin.settings.hideUnreachedDates
      };
    }
...
class DailyNoteView extends require$$0.ItemView {
  constructor(leaf, plugin) {
    ...
    this.timeFieldActionEl = null;
    this.customRange = null;
    this.getMode = () => {
      return "source";
    };
    this.onFileCreate = (file) => {
      if (file instanceof require$$0.TFile) this.view.fileCreate(file);
    };
    this.onFileDelete = (file) => {
      if (file instanceof require$$0.TFile) this.view.fileDelete(file);
    };
    this.plugin = plugin;
...
class DailyNoteViewPlugin extends require$$0.Plugin {
  async onload() {
    ...
    addIconList();
    this.lastCheckedDay = require$$0.moment().local().format("YYYY-MM-DD");
  ...
  async checkDayChange() {
    const currentDay = require$$0.moment().local().format("YYYY-MM-DD");
